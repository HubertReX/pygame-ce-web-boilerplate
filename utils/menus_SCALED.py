...
from settings import (
    ABOUT, FPS_CAP, HEIGHT, HEIGHT_SCALED, HUD_DIR, INPUTS, INVENTORY_ITEM_SCALE,
    IS_WEB, MENU_FONT, PANEL_BG_COLOR, SCALE, SHOW_DEBUG_INFO, WIDTH, WIDTH_SCALED
)
...
class MainMenuScreen(MenuScreen):
    ...
    def create_menu(self) -> pygame_menu.Menu:
        ...
        main_menu = pygame_menu.Menu(
            width=WIDTH_SCALED * 0.2,
            height=HEIGHT_SCALED * 0.4,
            # position = (2 * WIDTH // 3, 50, False),
            position =(50, HEIGHT_SCALED // 2, False),
            theme=main_theme,
            title="Main Menu",
            mouse_visible=False,
        )
