...
# tags: text width, text, max text width, font_auto_multilines_width, advanced styling,
# set_max_text_width, set_size, set_style_attr, set_size, set_text
...
some_long_text = "Hello, world. This is a long text that I wrote for the demo. " * 2
...
t.stick_to(my_button, "bottom", "top", (10, 10))
